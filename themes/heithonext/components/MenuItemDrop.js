            ...
            return (
              <li key={sLink.id}>
                <Link
                  href={sLink.href}
                  target={sLink.target}
                  className='my-auto h-9 px-2 items-center justify-start flex not:last-child:border-b-0 border-b text-gray-700 dark:text-gray-200  hover:bg-gray-50 dark:hover:bg-red-900 tracking-widest transition-all duration-200  dark:border-gray-800 '>
                  {sLink.icon && (
